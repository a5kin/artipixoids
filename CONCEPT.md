...
P<sub>0</sub> = &#8484;,  
P<sub>n + 1</sub> = P<sub>n</sub><sup>1</sup> &cup; P<sub>n</sub><sup>2</sup> &cup; ... &cup; P<sub>n</sub><sup>&infin;</sup>, &emsp;&emsp; (13)
...
c<sub>i</sub> = &lang;S<sub>0</sub>, ..., S<sub>N</sub>&rang;, &emsp; S<sub>i</sub> &isin; S<sub>s</sub> &forall; i &isin; [0 .. N], &emsp;&emsp; (17)
